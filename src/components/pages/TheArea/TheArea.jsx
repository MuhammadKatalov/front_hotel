    ...
    <div className={styles.area__page}>
      ...
      <div className={styles.main__content}>
        ...
        <div className={styles.text__content}>
          ...
          <div className={styles.text__3}>
            ...
            джунглей, озерами, водопадом и многим другим чего нам так не хватает
      ...
      <div className={styles.rest__shop}>
        ...
        <div className={styles.rest__text}>
          ...
          <div className={styles.rest__text2}>
            ...
            перечисленного, вы можете пройтись по крутым магазинам и попробовать
            вкусную Датскую кухню
          </div>
        </div>
      </div>
      ...
      <div className={styles.domiki__info}>
        <div className={styles.domiki__text}>
          ...
          возвышением, откуда начинается путь к нашей хижине. Здесь вы так же можете
          устроить себе небольшую прогулку
        </div>
